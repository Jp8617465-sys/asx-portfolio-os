"""
Pytest configuration for ensemble route tests.

Sets up test environment, mocks database connections, and provides
fixtures for FastAPI TestClient and service mocks.
"""
...
def mock_database_connections():
    ...
    with patch('app.core.db') as mock_db, \
         ...
         patch('app.features.signals.routes.ensemble_routes.db_context') as mock_route_ctx, \
