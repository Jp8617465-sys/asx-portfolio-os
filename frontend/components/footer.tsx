...
const socialLinks = [
  { icon: Github, href: 'https://github.com/asx-portfolio-os', label: 'GitHub' },
  { icon: Twitter, href: 'https://twitter.com/asxportfolioos', label: 'Twitter' },
  { icon: Mail, href: 'mailto:hello@asxportfolioos.com', label: 'Email' },
];
